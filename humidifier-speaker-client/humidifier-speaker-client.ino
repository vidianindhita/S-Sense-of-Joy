...
//    Serial.println("connecting...");
    ...
    client.println("GET /obtain_song_info HTTP/1.1");
  ...
  songTitle = root["songTitle"].as<char*>();
  songFeatures = root["songFeatures"]["danceability"].as<char*>();

  danceability = songFeatures.toFloat();

  if (prevDanceability != danceability) {
    Serial.println("CHANGE SONG");
    Serial.println(F("Response:"));
    Serial.print("Title: ");
    Serial.println(songTitle);
    Serial.print("Danceability: ");
